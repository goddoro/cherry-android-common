...
object NetworkModule {
    ...
    @Singleton
    @Provides
    fun provideOkHttpClient(userHolder: UserHolder, @ApplicationContext context: Context): OkHttpClient {
...
class CherryInterceptor @Inject constructor(
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        val request = chain.request().newBuilder()
            ...
            .header("x-cherry-version", context.packageManager.getPackageInfo(context.packageName,0).versionName)
            .build()
